...
using SistemaFacturacion.Infrastructure.Identity.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\SistemaFacturacion.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
        ...
        public static void AddContextInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            else
            {
                ...
                services.AddDbContext<FacturacionDbContext>(options => options.UseNpgsql(configuration.GetConnectionString("FacturacionConnection"), b => b.MigrationsAssembly(typeof(FacturacionDbContext).Assembly.FullName)));
            }
